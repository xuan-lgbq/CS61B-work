...
public class IntListExercises {
    ...
    public static void setToZeroIfMaxFEL(IntList L) {
        ...
        while (p != null) {
            ...
            //where we can use this code to check our function respectively to make sure they are valid.
            //Moreover, it is more convenient for us to debug them.
    ...
    return squarePrimes(lst.rest) || hasPrime;
        //The order matters, if we put squarePrimes first then the code will check the squarePrimes first and then check the hasPrime.
        //which means until we recurse the whole list then we use the order of "return".
    }
}
